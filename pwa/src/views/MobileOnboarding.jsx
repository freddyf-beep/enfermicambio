...
export function ConnectSheet({ close }) {
  ...
  return <>
    ...
    <div className="muted small" style={{ marginBottom: 14 }}>
      Abre Ajustes → “Emparejar app móvil” en EnfermiCambio e introduce la dirección y el código que aparecen allí.
    </div>
...
export default function MobileOnboarding() {
  ...
  const head = <>
    ...
    <h1 style={{ fontSize: 34, fontWeight: 700, letterSpacing: '-.028em', margin: '10px 0 4px' }}>EnfermiCambio</h1>
  </>
  const wrap = { display: 'flex', flexDirection: 'column', justifyContent: 'center', minHeight: '78vh', textAlign: 'center' }
  return (
    <div className="narrow" style={wrap}>
      {head}
      <div className="muted" style={{ marginBottom: 34 }}>¿Cómo quieres usar EnfermiCambio?</div>
      ...
      <div className="dim small" style={{ marginTop: 26, lineHeight: 1.5 }}>
        El modo local mantiene todo en este teléfono. Al conectar, EnfermiCambio sincroniza tus datos y puedes cambiarlo luego en Ajustes.
      </div>
    </div>
  )
}
