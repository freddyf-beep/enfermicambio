  ...
  if (DEMO) return (
    <div className="narrow" style={wrap}>
      ...
      <div className="card small muted" style={{ textAlign: 'left', marginTop: 16 }}>
        Esta demostración funciona con datos de ejemplo en tu navegador; no envía nada. Una cuenta de EnfermiCambio mantiene tus dispositivos sincronizados.
      </div>
  ...
  return (
    <div className="narrow" style={wrap}>
      ...
      {webauthnOK() ? <>
        ...
        ? 'Este navegador no admite passkeys; todavía puedes usar EnfermiCambio localmente.'
