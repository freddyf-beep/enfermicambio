...
const P = {
  ...
  sliders: <><path d="M4 6.5h6M14 6.5h6M4 12h10M18 12h2M4 17.5h3M11 17.5h9" /><circle cx="12" cy="6.5" r="2" /><circle cx="16" cy="12" r="2" /><circle cx="9" cy="17.5" r="2" /></>,
  ...
  people: <><circle cx="8.6" cy="8" r="3" /><path d="M3.6 19.7a5 5 0 0 1 10 0" /><circle cx="16.9" cy="8.8" r="2.3" /><path d="M15.4 14.2a4.3 4.3 0 0 1 5 4.3" /></>,
  ...
  activity: <path d="M3.4 12h3.8l2-5.2 4.1 10.4 2.2-5.2h5.1" />,
  ...
  camera: <><path d="M4.2 8.2h3l1.4-2.3h6.8l1.4 2.3h3v10.2H4.2Z" /><circle cx="12" cy="13.1" r="3.3" /></>,
  image: <><rect x="3.7" y="4.4" width="16.6" height="15.2" rx="2.6" /><circle cx="8.2" cy="9" r="1.6" /><path d="m5.7 17.4 4.4-4.3 2.5 2.3 2.1-2 3.6 4" /></>,
  food: <><path d="M6.2 3.8v6.1M9.2 3.8v6.1M6.2 7h3M7.7 9.9v10.3" /><path d="M15.3 3.8v16.4M15.3 3.8c3 1.2 3.5 5.7 0 8" /></>,
  barcode: <><path d="M4.2 8V4.2H8M16 4.2h3.8V8M19.8 16v3.8H16M8 19.8H4.2V16" /><path d="M7.2 9.4v5.2M9.7 9.4v5.2M13 9.4v5.2M16.2 9.4v5.2" /></>,
  route: <><circle cx="5.2" cy="17.8" r="2" /><circle cx="18.8" cy="6.2" r="2" /><path d="M7.2 17.8h2.2a2.6 2.6 0 0 0 0-5.2H8.1a2.6 2.6 0 0 1 0-5.2h8.7" /></>,
  mountain: <><path d="m3.2 19.5 6.6-11 3 4.2 2.4-3.5 5.6 10.3Z" /><path d="m8.1 11.3 1.7 1.6 1.2-1.5M13.8 11.2l1.4 1.4 1.2-1.3" /></>,
  ...
  refresh: <><path d="M19.2 8.3A7.6 7.6 0 0 0 6.6 6.5L4.4 8.8" /><path d="M4.4 4.8v4h4" /><path d="M4.8 15.7a7.6 7.6 0 0 0 12.6 1.8l2.2-2.3" /><path d="M19.6 19.2v-4h-4" /></>,
  ...
  share: <><circle cx="6" cy="12" r="2.3" /><circle cx="17.8" cy="6" r="2.3" /><circle cx="17.8" cy="18" r="2.3" /><path d="m8.1 10.9 7.6-3.8M8.1 13.1l7.6 3.8" /></>,
