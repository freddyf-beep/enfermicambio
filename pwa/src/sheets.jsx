...
function PlanTools({ close }) {
  ...
  const exportFile = async () => {
    ...
    const name = 'enfermicambio-plan-' + todayISO() + '.json'
  ...
  return <>
    ...
    <div className="dim small" style={{ margin: '7px 2px 0', lineHeight: 1.4 }}>Un archivo pequeño para compartir rutinas de EnfermiCambio, sin entrenamientos ni pesajes personales.</div>
    {!MOBILE && <>
      <div style={{ height: 12 }} />
...
function FinishSummary({ w, prs, e1prs = [], close }) {
  ...
  return <div style={{ textAlign: 'center', padding: '8px 0' }}>
    ...
    <div style={{ height: 14 }} />
    <Button variant="primary" onClick={() => { close(); nav('/train') }}>{t('Nice!')}</Button>
  </div>
}
