...
| 8 | 2026-08-11 | Completed | Spanish transformation and five-tab redesign completed. The insecure legacy quick-login implementation was removed during the PWA migration; credentials were deliberately redacted from this archived document. | Local Flutter build completed at the time; superseded by the PWA client. |
