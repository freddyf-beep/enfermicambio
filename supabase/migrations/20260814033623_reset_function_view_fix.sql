-- season_standings is a read-only view over season_points, not a table.
-- Removing season_points is sufficient to reset that derived ranking.
...
declare
  ...
  result jsonb := jsonb_build_object(
    ...
    'season_standings', 'derived_view_reset_by_season_points'
  );
begin
