-- The reset function must run as the caller. SECURITY DEFINER changes
-- current_user to the postgres owner, making a service-role check both
-- ineffective and impossible to validate. Keep the allowlist on the
-- invoker role and revoke the function from public API roles.
